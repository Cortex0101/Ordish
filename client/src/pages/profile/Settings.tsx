/*
example structure using pure HTML (use React Components instead):
<div class="container">
...
import "./Settings.scss"; // Assuming you have a Settings.scss for styles

import { settingsTestIds } from "./Settings.testIds"; // Assuming you have a test IDs file for Settings