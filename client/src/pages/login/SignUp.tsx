    ...
    <Container className="container-sm" data-testid={signUpTestIds.container}>
      <Row className="justify-content-center">
        <Col xs={12} md={8} lg={6}>
          ...
          {error && (
            <Alert variant="danger" className="mt-3" data-testid={signUpTestIds.errorAlert}>
              {error}
            </Alert>
          )}

          <Form className="mt-4" onSubmit={handleSignUp} data-testid={signUpTestIds.form}>
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formEmailDisplay" data-testid={signUpTestIds.emailGroup}>
                <Form.Label data-testid={signUpTestIds.emailLabel}>Email</Form.Label>
                <Form.Control
                  type="email"
                  value={email}
            ...
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formUsernameDisplay" data-testid={signUpTestIds.usernameGroup}>
                <Form.Label data-testid={signUpTestIds.usernameLabel}>{t("username")}</Form.Label>
                <Form.Control
                  type="text"
            ...
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formPassword" data-testid={signUpTestIds.passwordGroup}>
                <Form.Label data-testid={signUpTestIds.passwordLabel}>{t("password")}</Form.Label>
                <Form.Control
                  type="password"
                ...
                />
                <Form.Text className="text-muted" data-testid={signUpTestIds.passwordHelpText}>
                  {t("password-requirements")}
                </Form.Text>
              </Form.Group>
            </Row>
            <Row className="mb-3">
              <Col className="d-grid gap-2" data-testid={signUpTestIds.submitButtonGroup}>
                <Button
                  variant="primary"
                  size="lg"
                  type="submit"
                ...
                >
                  {isFormLoading ? (
                    <>
                      <Spinner size="sm" className="me-2" data-testid={signUpTestIds.submitButtonSpinner} />
                      <span data-testid={signUpTestIds.submitButtonText}>{t("creating-account")}</span>
                    </>
                  ) : (
                    <span data-testid={signUpTestIds.submitButtonText}>{t("create-account")}</span>
                  )}
                </Button>
              </Col>
            </Row>
            <Row className="mb-3">
              <Col className="text-center" data-testid={signUpTestIds.signInLinkGroup}>
                <span className="text-muted" data-testid={signUpTestIds.signInLinkText}>
                  {t("already-have-account")}{" "}
                  <a href="/login" className="link-primary" data-testid={signUpTestIds.signInLink}>
                    {t("sign-in")}
                  </a>
                </span>
              </Col>
        ...
        <div className="d-flex align-items-center my-4" data-testid={signUpTestIds.divider}>
          <hr className="flex-grow-1" />
          <span className="mx-3 text-muted" data-testid={signUpTestIds.dividerText}>{t("or")}</span>
          <hr className="flex-grow-1" />
        </div>
        ...
        <Row className="mb-2">
          <Col data-testid={signUpTestIds.facebookButtonGroup}>
            ...
            >
              ...
              <span data-testid={signUpTestIds.facebookButtonText}>{t("signin-facebook")}</span>
            </Button>
          </Col>
        </Row>
        <Row className="mb-2">
          <Col data-testid={signUpTestIds.appleButtonGroup}>
            ...
            >
              ...
              <span data-testid={signUpTestIds.appleButtonText}>{t("signin-apple")}</span>
            </Button>
          </Col>
        </Row>
        <Row className="mb-2">
          <Col data-testid={signUpTestIds.googleButtonGroup}>
            ...
            >
              ...
              <span data-testid={signUpTestIds.googleButtonText}>{t("signin-google")}</span>
            </Button>
          </Col>
        </Row>
        </div>
