...
i18n
  ...
  .init({
    resources: {
      da: { common: daCommon, signup: daSignup, home: daHome, header: daHeader, login: daLogin },
      en: { common: enCommon, signup: enSignup, home: enHome, header: enHeader, login: enLogin }
    },
    fallbackLng: 'da',
